...
%>
    ...
    <div class="mainBoxLeft">
     ...
     <%End IF%>
	 <div>由于更新频繁，该参数只作参考由于更新频繁，该参数只作参考由于更新频繁，该参数只作参考由于更新频繁，该参数只作参考由于更新频繁，该参数只作参考由于更新频繁，该参数只作参考</div>
	</div>
...
response.Write("<ul class='show"&j&"'>")
	...
	response.Write("<li><a href='project.asp?lmid="& rs3("ClassId") &"'>" & rs3("ClassName") & "</a></li>")
