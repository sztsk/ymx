...
%>
<title>园境·展示 | 深圳亚玛迅雕塑园林艺术有限公司</title>
...
%>
    	<a href="index.html">首页</a> > 重点案例 >  园境·展示 <%'=lm_rs("ClassName")%></div>
        <!-- right -->
        <%
...
%>
    ...
    <div class="mainBoxRight" id="js_Show">
	  <div class="leftMenu">
		...
		<ul id="ppul">
		  <li><a href="proNext.asp?id=2">类型</a></li>
		  <li><a href="proNextDy.asp?id=2">地域</a></li>
		  <!--li><a href="proNextNf.asp?id=2">&middot;年份&middot;</a></li-->
		</ul>
	  </div>
	  <div class="leftPhoto">
		<ul>
