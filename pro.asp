...
%>
    	<a href="index.html">首页</a> > 重点案例 >  雕塑·饰品 <%'=lm_rs("ClassName")%></div>
        <!-- right -->
        <%
...
%>
    ...
    <div class="mainBoxRight" id="js_Show">
	  <div class="leftMenu">
		<ul>
		  <li><a href="proNext.asp">&middot;类型&middot;</a></li>
		  <li><a href="proNextDy.asp">&middot;地域&middot;</a></li>
		  <li><a href="proNextNf.asp">&middot;年份&middot;</a></li>
		</ul>
	  </div>
	  <div class="leftPhoto">
		<ul>
