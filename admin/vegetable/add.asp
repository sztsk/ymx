...
<% Call Header%>
    <!--start  -->
<form id="insertForm" action="vegetableManage.asp?action=InsertVege" method="post" enctype="multipart/form-data" >
  <table id="editTable" class="ui-widget ui-widget-content tableBlue" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="47%"><input type="text" name="vegetableName" id="vegetableName" class="text ui-widget-content ui-corner-all" /></td>
      <td width="42%">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="file" name="vsmallImg" id="vsmallImg" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td class="textRight">大图</td>
      <td><input type="file" name="vbigImg" id="vbigImg" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td></td>
